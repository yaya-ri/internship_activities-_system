      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="" href="<?php echo base_url();?>index.php/admin/a_profile_c">
                  ...
                  <li class="sub-menu">
                    <div class="menu-profile">
                      <a href="<?php echo base_url();?>index.php/admin/a_student_management_c" >
                  ...
                  <li class="sub-menu">
                    <div class="menu-profile">
                      <a href="<?php echo base_url();?>index.php/admin/a_mentor_management_c" >
                          <i class="glyphicon glyphicon-user"></i>
                  ...
                  <li class="sub-menu">
                    <div class="menu-profile">
                      <a href="<?php echo base_url();?>index.php/admin/a_internship_management_c" >
                          <i class="glyphicon glyphicon-cog"></i>
                          <span>Menejemen Magang</span>
                      </a>
                    </div>  
                  </li>
              </ul>

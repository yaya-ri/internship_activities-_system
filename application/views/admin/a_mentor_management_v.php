<script type="text/javascript">
    ...
    if (confirm("hapus?"+id)) {
        ...
        $.ajax({
            url: "<?php echo base_url('index.php/admin/a_mentor_management_c/delete_form/')?>",
            type: "POST",
            data: {id:id},
            success: function (data) {
...
<script type="text/javascript">
    ...
    if (confirm("Reset password?")) {
        $.ajax({
            url: "<?php echo base_url('index.php/admin/a_mentor_management_c/reset_pass/')?>",
            type: "POST",
            data: {id:id},
            success: function (data) {
...
<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">Akun Mentor</h3>
  </div>
  <div class="panel-body">
    <div class="table-responsive">
					...
					<ul class="breadcrumb">
						<li><a href="#">Home</a></li>
						<li class="active">Akun Mentor</li>
					</ul>
			    ...
			    <thead>
			    	...
			    	<tbody id="data">
						<?php $this->load->view('admin/a_table_mentor_v') ; ?>			    
			    	</tbody>		            
			    </table>
...
<?php $this->load->view('admin/a_mentor_edit_v') ; ?>

<?php $this->load->view('admin/a_mentor_add_v') ; ?>

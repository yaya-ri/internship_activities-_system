...
<div class="panel panel-default">
  <div class="panel-heading"><h2 class="panel-title"> <b> Daftar Semua Aktivitas Doing </b></h3></div>
    ...
    <div class="breadcrumb-line">
			<?php foreach ($mg_activity as $b) { ?>
				<ul class="breadcrumb">
					...
					<li class="active"><?php echo $b->student_first_name." ".$b->student_last_name; ?></li>
				</ul>
           ...
           <div class="table-responsive" id="data_aktivitas">
			    ...
			    <tbody id="data">
			    	<?php $this->load->view('s_activity_doing_table_v') ?>
			    </tbody>		            
			    </table>
		...
		<?php $this->load->view('s_activity_doing_edit_v'); ?>

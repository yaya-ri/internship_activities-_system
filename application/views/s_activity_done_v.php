...
<div class="panel panel-default">
  <div class="panel-heading"><h2 class="panel-title"> <b> Daftar Semua Aktivitas Done</b></h3></div>
  <div class="panel-body">
    <div class="breadcrumb-line">
           ...
           <div class="table-responsive" id="data_aktivitas">
			    ...
			    <tbody id="data">
			    	<?php $this->load->view('s_activity_done_table_v') ?>
			    </tbody>		            
			    </table>
		...
		<?php $this->load->view('s_activity_done_edit_v'); ?>

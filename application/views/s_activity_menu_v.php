        ...
        <div class="row">
            <div class="col-lg-3">
              <div class="panel panel-info">
                ...
                <a href="<?php echo base_url();?>index.php/s_activity_c/todo">
            ...
            <div class="col-lg-3">
              <div class="panel panel-warning">
                ...
                <a href="<?php echo base_url();?>index.php/s_activity_c/doing">
                  <div class="panel-footer announcement-bottom">
                    <div class="row">
                      <div class="col-xs-6">
                        <b style="font-size: 15px;">Lihat</b>
            ...
            <div class="col-lg-3">
              <div class="panel panel-danger">
                ...
                <a href="<?php echo base_url();?>index.php/s_activity_c/review">
                  <div class="panel-footer announcement-bottom">
                    <div class="row">
                      <div class="col-xs-6">
                        <b style="font-size: 15px;">Lihat</b>
            ...
            <div class="col-lg-3">
              <div class="panel panel-success">
                ...
                <a href="<?php echo base_url();?>index.php/s_activity_c/done">
                  <div class="panel-footer announcement-bottom">
                    <div class="row">
                      <div class="col-xs-6">
                       <b style="font-size: 15px;">Lihat</b>

       ...
       if($a->activity_status==$todo){ ?>
        <tr>
            ...
            <td class="text-center">
            	...
            	<!-- <?php echo anchor('s_activity_edit_c/delete/'.$a->activity_id, ' ', array('class' => 'btn btn-danger btn-xs, glyphicon glyphicon-trash ')); ?> -->
            	<button title="lihat detail" type="button" class="btn btn-danger" onclick="hapus(<?php echo $a->activity_id;?>)"><div class="glyphicon glyphicon-trash" ></div></button>

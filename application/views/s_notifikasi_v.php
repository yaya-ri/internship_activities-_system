<li id="header_inbox_bar" class="dropdown">
    ...
    <ul class="dropdown-menu extended inbox">
        ...
        <li>
            ...
            <?php $batas=0; foreach ($notifikasi as $a) { 
              
              if($a->mention_read==0 && $a->mention_status==2 && $batas<=5 ){
              ?>
              <li>
                  <a href="<?php echo base_url('index.php/s_detail_activity_c/read_notification');?>/<?php echo $a->activity_id; ?>">
